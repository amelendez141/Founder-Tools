  ...
  return (
    <div>
      <div className="flex justify-between items-center mb-8">
        ...
        {canCreateMore && (
          <Button onClick={() => createVenture()} isLoading={isCreating}>
            Create New Venture
          </Button>
        )}
      </div>
      ...
      {ventures.length === 0 ? (
        <Card>
          <CardContent className="py-12 text-center">
            ...
            <h3 className="text-lg font-medium text-gray-900">Start your first venture</h3>
            <p className="text-gray-500 mt-1">Create a venture to begin your entrepreneurial journey</p>
            <Button className="mt-4" onClick={() => createVenture()} isLoading={isCreating}>
              Create Venture
            </Button>
          </CardContent>
        </Card>
              ...
              <Card className="h-full hover:shadow-md transition-shadow cursor-pointer">
                ...
                <CardContent>
                  {venture.problem_statement ? (
                    <p className="text-sm text-gray-600 line-clamp-3">{venture.problem_statement}</p>
                  ) : (
                    <p className="text-sm text-gray-400 italic">No problem statement yet</p>
                  )}
                  <div className="mt-4">
                    <Progress value={20} />
